...
def start(message):
    ...
    btn1 = markup.add("1stNew", "1stOld")
    btn2 = markup.add("2ndNew", "2ndOld")
    btn3 = markup.add("3rdNew", "3rdOld")
    btn4 = markup.add("4th", "5th")
    btn5 = markup.add("6th", "7th", "8th")
    
    bot.send_message(
        message.chat.id,
        "🎓 *Welcome to Syllabus Bot* 🎓\n\n📚 *Select your Semester:*",
        reply_markup=markup,
        parse_mode='Markdown'
    )
...
def sem_select(message):
    ...
    # Get available branches for this semester
...
def send_pdf(message):
    ...
    try:
        ...
        with bot.send_document(message.chat.id, file_url, caption=f"📚 *{sem} Semester - {branch} Branch*\n\n✅ Download complete!", parse_mode='Markdown') as sent_msg:
            pass
            
        # Clean user data after successful delivery
